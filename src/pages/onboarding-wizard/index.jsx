...
import { registerSchoolBasic } from "../../services/onboardingService";
...
const OnboardingWizard = () => {
  ...
  const handleSubmit = async () => {
    ...
    const payload = {
      ...
      schoolPhone: formData.phoneNumber.replace(/\s+/g, ""),
    ...
    try {
      await registerSchoolBasic(payload);
        ...
        <div className="relative z-10">
          ...
          <div className="max-w-md">
            ...
            <p className="text-blue-100 text-lg mb-20 leading-relaxed">
              Join thousands of schools managing their finances efficiently
            </p>
      ...
      <div className="flex-1 flex flex-col p-6">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="w-full max-w-2xl">
            ...
            <div className="bg-white rounded-2xl border border-[#0a1f44] p-8 mb-6 shadow-sm">
              {/* Submit Error */}
              {errors?.submit && (
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 bg-gray-50 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent focus:bg-white outline-none transition ${errors?.schoolName ? 'border-red-300' : 'border-gray-200'
                      }`}
                  />
                  {errors?.schoolName && (
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 bg-gray-50 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent focus:bg-white outline-none transition ${errors?.email ? 'border-red-300' : 'border-gray-200'
                      }`}
                  />
                  {errors?.email && (
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    Please add country prefix i.e. "+234 8000000000"
                  </p>
                </div>
              </div>
            </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    <input
                      ...
                      className={`w-full px-4 py-3 bg-gray-50 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent focus:bg-white outline-none transition ${errors?.state ? 'border-red-300' : 'border-gray-200'
                        }`}
                    />
                    <input
                      type="text"
                      ...
                      className={`w-full px-4 py-3 bg-gray-50 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent focus:bg-white outline-none transition ${errors?.city ? 'border-red-300' : 'border-gray-200'
                        }`}
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <input
                      ...
                      className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent focus:bg-white outline-none transition"
                    />
                    <input
                      type="text"
            ...
            {/* Submit Button - Outside forms */}
            <div className="flex justify-end">
              <button
                type="button"
                onClick={handleSubmit}
                disabled={isLoading}
                className="w-12 h-12 bg-[#0a1f44] text-white rounded-full hover:bg-[#0d2850] transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-lg flex items-center justify-center"
              >
                {isLoading ? (
