...
const SchoolLogin = () => {
  ...
  return (
    <div className="min-h-screen flex bg-gray-50">
      <div
        className="hidden lg:flex lg:w-[45%] bg-gradient-to-br from-[#1a2c5b] via-[#0f1f44] to-[#0a1a38]
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <div className="max-w-md">
            <h1 className="text-5xl font-bold leading-tight">Access Your Finance Hub</h1>
